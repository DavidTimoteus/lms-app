        ...
        <div class="container">
            <div class="card mt-5">
                <div class="card-header">
                    ...
                    <h2 class="text-center">Create New Account</h1>
                        <h6 class="text-center">Learning Management System</h6>
                        <hr>
                </div>
                <div class="card-body">
                    <form id="form-register" method="POST" action="{{ route('postregister') }}">
                        @csrf
                        ...
                        <div class="col-12">
                            <p class="m-0 text-secondary text-center">Don't have an account? <a
                                    href="{{ route('login') }}" class="link-primary text-decoration-none">Sign up</a>
                            </p>
                        </div>
                    </form>
                </div>
